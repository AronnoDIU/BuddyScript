...
#[ORM\Index(name: 'idx_group_post_created_at', columns: ['created_at'])]
#[ORM\Index(name: 'idx_group_post_group', columns: ['group_id'])]
class GroupPost
{
    #[ORM\Id]
    ...
    /**
     * @return Collection<int, GroupPostLike>
     */
    ...
    public function addLike(GroupPostLike $like): self
    {
    ...
    /**
     * @return Collection<int, GroupPostComment>
     */
    ...
    public function addComment(GroupPostComment $comment): self
    {
